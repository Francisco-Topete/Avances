...
namespace Pagina.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            ViewBag.GemaID = new SelectList(db.Gemas, "ID", "Nombre");
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Descripcion,TipoID,GemaID,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Descripcion,TipoID,GemaID,Precio")] Producto producto)
        {
            if (ModelState.IsValid)
            {
